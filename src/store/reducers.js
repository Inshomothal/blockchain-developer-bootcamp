export const provider = (state = {}, action) => {switch(action.type) {
...
const DEFALT_TOKENS_STATE = {
    loaded: false,
    contracts: [],
    symbols: []
}

export const tokens = ( state = DEFALT_TOKENS_STATE, action) => {
    switch (action.type) {
        case 'TOKEN_1_LOADED':
            return {
                ...state,
